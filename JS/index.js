...
function ReadResult() {
  ...
  oSubject1 = oSubject1.filter(function (e) {
    return e
  });
...
function ChartRendering() {
  ...
  var chart = new CanvasJS.Chart("chartContainer1", {
    ...
    data: [{
      ...
      legendText: "",
      dataPoints: [{
          y: oSubjectAverage[0]["ENGLISH"],
          label: "English"
        },
        {
          y: oSubjectAverage[1]["MATHEMATICS"],
          label: "Mathematics"
        },
        {
          y: oSubjectAverage[2]["PHYSICS"],
          label: "Physics"
        },
        {
          y: oSubjectAverage[3]["CHEMISTRY"],
          label: "Chemistry"
        },
        {
          y: oSubjectAverage[4]["BIOLOGY"],
          label: "Biology"
        },
        {
          y: oSubjectAverage[5]["IP"],
          label: "IP"
        }
      ]
    }]
...
function ChartRenderingStudentPassedSubjectWise() {
  ...
  var chart = new CanvasJS.Chart("chartContainer", {
    ...
    data: [{
        ...
        dataPoints: [{
            y: oTotalStudentapeared[0],
            label: "Students-Appeared"
          },
          {
            y: oTotalStudentapeared[1],
            label: "Students-Appeared"
          },
          {
            y: oTotalStudentapeared[2],
            label: "Students-Appeared"
          },
          {
            y: oTotalStudentapeared[3],
            label: "Students-Appeared"
          },
          {
            y: oTotalStudentapeared[4],
            label: "Students-Appeared"
          },
          {
            y: oTotalStudentapeared[5],
            label: "Students-Appeared"
          }
        ]
      },
      ...
      },
      {
        ...
        dataPoints: [{
            y: oTotalStudentapeared[0] - oSubjectCounter[0],
            label: "Students-Failed"
          },
          {
            y: oTotalStudentapeared[1] - oSubjectCounter[1],
            label: "Students-Failed"
          },
          {
            y: oTotalStudentapeared[2] - oSubjectCounter[2],
            label: "Students-Failed"
          },
          {
            y: oTotalStudentapeared[3] - oSubjectCounter[3],
            label: "Students-Failed"
          },
          {
            y: oTotalStudentapeared[4] - oSubjectCounter[4],
            label: "Students-Failed"
          },
          {
            y: oTotalStudentapeared[5] - oSubjectCounter[5],
            label: "Students-Failed"
          }
        ]
      },
...
function ChartRenderingPercentageWise() {
  ...
  var chart = new CanvasJS.Chart("chartContainer2", {
    ...
    data: [{
      ...
      legendText: "",
      dataPoints: [{
          y: oPercentageResult[0],
          label: "<40"
        },
        {
          y: oPercentageResult[1],
          label: "40-49.9"
        },
        {
          y: oPercentageResult[2],
          label: "50-59.9"
        },
        {
          y: oPercentageResult[3],
          label: "60-69.9"
        },
        {
          y: oPercentageResult[4],
          label: "70-79.9"
        },
        {
          y: oPercentageResult[5],
          label: "80-89.9"
        },
        {
          y: oPercentageResult[6],
          label: ">=90"
        }
      ]
    }]
...
function ChartRenderingDistinction() {
  ...
  var chart = new CanvasJS.Chart("chartContainer3", {
    ...
    data: [{
      ...
      legendText: "",
      dataPoints: [{
          y: oSubjectDistinction[0],
          label: "ENGLISH"
        },
        {
          y: oSubjectDistinction[1],
          label: "MATHEMATICS"
        },
        {
          y: oSubjectDistinction[2],
          label: "PHYSICS"
        },
        {
          y: oSubjectDistinction[3],
          label: "CHEMISTRY"
        },
        {
          y: oSubjectDistinction[4],
          label: "BIOLOGY"
        },
        {
          y: oSubjectDistinction[5],
          label: "IP"
        }
      ]
    }]
